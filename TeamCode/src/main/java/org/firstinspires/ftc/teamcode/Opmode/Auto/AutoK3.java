...
@Config
@Autonomous
public class AutoK3 extends LinearOpMode {
...
//                .strafeToLinearHeading(new Vector2d(-43, -55), Math.toRadians(0))  // <--
                .strafeToLinearHeading(new Vector2d(-51.000, -46), Math.toRadians(60))
                .waitSeconds(0.3)
                .stopAndAdd(()->new A_Score_Reset_Sample(outtake,gripOpenTime))
                .waitSeconds(0.2)//0.1
                //ROBOT INIT
                ...
                .afterTime(0.01,()->new A_SamplePrePick(intake,outtake))     //INTAKE INIT  READY FOR PICK
                .afterTime(0.01,()->new A_OuTake_Before_Trans(intake,outtake)) //DELIVERY INIT
                .afterTime(0.01,()->new A_Sample_OutTake_G(intake,outtake, Outtake.GripperState.OPEN))


                .waitSeconds(0.3)
                .strafeToLinearHeading(new Vector2d(-51.1, -40), Math.toRadians(72))
                //todo transfer start
                .afterTime(0.1,()->new A_Sample_Pick(intake))//intake just before transfer pre transfer
                .afterTime(0.1,()->new A_Sample_Transfer_G(intake,outtake, Intake.iGripperStates.CLOSE)) //intake transfer pose
                .afterTime(0.2,()->new A_Sample_OutTake_G(intake,outtake, Outtake.GripperState.CLOSE)) //delivery tranfer pose
                ...
                .strafeToLinearHeading(new Vector2d(-51.11, -40), Math.toRadians(60))
                .waitSeconds(0.3)
                .stopAndAdd(()->new A_Score_Reset_Sample(outtake,gripOpenTime))
                .waitSeconds(0.2)//0.1
                //ROBOT INIT
...
//                .afterTime(0.8,()->new A_High_Bucket_Pose(outtake))
//
//                .strafeToLinearHeading(new Vector2d(-51, -50.01), Math.toRadians(60))
//                .waitSeconds(0.3)
//                .stopAndAdd(()->new A_Score_Reset_Sample(outtake,gripOpenTime))
//                .waitSeconds(0.2)//0.1
//                //ROBOT INIT
...
//                .strafeToLinearHeading(new Vector2d(-51.001, -50.001), Math.toRadians(90))
...
//                .waitSeconds(0.3)
                ...
                // TODO
//                .strafeToLinearHeading(new Vector2d(-51, -50.0001), Math.toRadians(60))
//                .stopAndAdd(()->new IntakeGripCommand(intake, Intake.iGripperStates.CLOSE))
//                .waitSeconds(0.2)
