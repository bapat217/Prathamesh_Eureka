...
@Config
@Autonomous
public class AutoP_AFTERNOON extends LinearOpMode {
...
//                //TODO DROP ALLIANCE YELLOW
                ...
                .strafeToLinearHeading(new Vector2d(-43.5, -59), Math.toRadians(0)) // was 43 made 40
//                .waitSeconds(0.0)
                .stopAndAdd(()->new A_Score_Reset_Sample(outtake,gripOpenTime))
                .waitSeconds(0.2)//0.1
...
//                .strafeToLinearHeading(new Vector2d(-44.001, -52), Math.toRadians(30))
                .strafeToLinearHeading(new Vector2d(-46.001, -51), Math.toRadians(30))
//                .strafeToLinearHeading(new Vector2d(-52.001, -48), Math.toRadians(70))
//
                .waitSeconds(0.5)
                .stopAndAdd(()->new A_Score_Reset_Sample(outtake,gripOpenTime))
                .waitSeconds(0.3) // 0.1
...
//                .strafeToLinearHeading(new Vector2d(-48.501, -52), Math.toRadians(30))// (-46.501, -52)
                .strafeToLinearHeading(new Vector2d(-56.001, -45.001), Math.toRadians(70)) // (-47.501,-51)
//
                .waitSeconds(0.7)//0.7
                .stopAndAdd(()->new A_Score_Reset_Sample(outtake,gripOpenTime))
                .waitSeconds(0.3) // 0.1
...
//                .strafeToLinearHeading(new Vector2d(-51.501, -51), Math.toRadians(30)) // (-47.501,-51)
                .strafeToLinearHeading(new Vector2d(-56.001, -44.005), Math.toRadians(70)) // (-47.501,-51)
//
                .waitSeconds(1)//0.7
                .stopAndAdd(()->new A_Score_Reset_Sample(outtake,gripOpenTime))
                .waitSeconds(0.3) // 0.1
