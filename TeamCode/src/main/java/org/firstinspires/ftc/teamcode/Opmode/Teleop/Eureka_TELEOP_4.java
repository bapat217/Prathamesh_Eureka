...
public class Eureka_TELEOP_4 extends LinearOpMode {
...
//                        new InstantAction(() -> specimenSpottedTest = true),  // To be tested
            ...
            if (specimen && gamepad2.start && ternery) {
                runningActions.add(new SequentialAction(
                        ScoreAndResetSequence.N_readyToSpecimenPick(outtake, intake),
...
//            if (transfer && (robot.horizontalExtension.getCurrentPosition() <= 2) && robot.colorSensorOut.getDistance(DistanceUnit.MM) <= Globals.ColourDistanceOutake) {
//                runningActions.add(new SequentialAction(
////                        new InstantAction(()-> elevatorExtended = true),
////                        new SleepAction(0.5),
//                        P_SamplePick.SampleOutTakeGOpen(intake, outtake),
...
//            {
//                runningActions.add(new SequentialAction(
//                                SpecimenOuttakeSequence.N_SpecimenOuttakeAfterPick(outtake),
...
//            }
            ...
            * */
            if (gamepad1.b && specimen) {
                runningActions.add(new SequentialAction(
                        ScoreAndResetSequence.N_ScoreAndResetSequenceAction(outtake, intake),
