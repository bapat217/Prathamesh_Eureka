...
// * @author Jackson
// */
//public class CustomMotor implements HardwareDevice {
//
//    public enum GoBILDA {
//        RPM_Custom(0, 0),RPM_30(5264, 30), RPM_43(3892, 43), RPM_60(2786, 60), RPM_84(1993.6, 84),
...
//     */
//    public CustomMotor(@NonNull HardwareMap hMap, String id) {
...
//     */
//    public CustomMotor(@NonNull HardwareMap hMap, String id, @NonNull GoBILDA gobildaType) {
...
//     */
//    public CustomMotor(@NonNull HardwareMap hMap, String id, double cpr, double rpm) {
//        this(hMap, id, GoBILDA.NONE);
//
