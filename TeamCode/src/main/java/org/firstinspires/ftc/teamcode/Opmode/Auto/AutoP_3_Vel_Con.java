...
@Config
@Autonomous
public class AutoP_3_Vel_Con extends LinearOpMode {
    private final RobotHardware robot = RobotHardware.getInstance();
    private MecanumDrive drive;
    Intake intake ;
    Outtake outtake;
    VelConstraint baseVelConstraint = new MinVelConstraint(Arrays.asList(
            new TranslationalVelConstraint(85.0)
//            new AngularVelConstraint(Math.PI / 2)
    ));

    public static double gripOpenTime=0.2;
    @Override
...
//                .waitSeconds(0.5) //remove this later
                ...
                */
                ...
                .strafeToLinearHeading(new Vector2d(23, -59), Math.toRadians(0),baseVelConstraint)
...
//                //TODO DROP ALLIANCE YELLOW
                ...
                .strafeToLinearHeading(new Vector2d(-43, -59), Math.toRadians(0),baseVelConstraint) // was 43 made 40
                .waitSeconds(0.2)
                .stopAndAdd(()->new A_Score_Reset_Sample(outtake,gripOpenTime))
                .waitSeconds(0.2)//0.1
...
//\
                ...
                .strafeToLinearHeading(new Vector2d(-45.001, -42), Math.toRadians(90))//(-45.001, -45)
                .stopAndAdd(()->new IntakeGripCommand(intake, Intake.iGripperStates.CLOSE))
                .waitSeconds(0.5)
...
//                .strafeToLinearHeading(new Vector2d(-44.001, -52), Math.toRadians(30))
                .strafeToLinearHeading(new Vector2d(-50.001, -48), Math.toRadians(70))
//
                .waitSeconds(0.7)
                .stopAndAdd(()->new A_Score_Reset_Sample(outtake,gripOpenTime))
                .waitSeconds(0.3) // 0.1
...
//
                ...
                .strafeToLinearHeading(new Vector2d(-58.001, -41.5), Math.toRadians(90)) //(-58.001, -43.5)
                .stopAndAdd(()->new IntakeGripCommand(intake, Intake.iGripperStates.CLOSE))
                .waitSeconds(0.5)
...
//
                ...
                .strafeToLinearHeading(new Vector2d(-58.001, -40.5), Math.toRadians(120)) // (-58.001, -42.5)
                .stopAndAdd(()->new IntakeGripCommand(intake, Intake.iGripperStates.CLOSE))
                .waitSeconds(0.5)
