...
@Config
@Autonomous
public class AutoP_3 extends LinearOpMode {
...
//                //TODO DROP ALLIANCE YELLOW
                ...
                .strafeToLinearHeading(new Vector2d(-43, -58), Math.toRadians(0)) // was 43 made 40
                .waitSeconds(0.2)
                .stopAndAdd(()->new A_Score_Reset_Sample(outtake,gripOpenTime))
                .waitSeconds(0.2)//0.1
...
//                .strafeToLinearHeading(new Vector2d(-51.501, -51), Math.toRadians(30)) // (-47.501,-51)
                .strafeToLinearHeading(new Vector2d(-56.001, -42.5), Math.toRadians(70)) // (-47.501,-51)
//
                .waitSeconds(1)//0.7
                .stopAndAdd(()->new A_Score_Reset_Sample(outtake,gripOpenTime))
                .waitSeconds(0.3) // 0.1
