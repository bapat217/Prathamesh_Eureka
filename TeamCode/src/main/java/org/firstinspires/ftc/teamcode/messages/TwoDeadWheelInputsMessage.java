...
public final class TwoDeadWheelInputsMessage {
    ...
    public TwoDeadWheelInputsMessage(PositionVelocityPair par, PositionVelocityPair perp, Orientation angles, AngularVelocity angularVelocity) {
        this.timestamp = System.nanoTime();
        this.par = par;
        this.perp = perp;
        {
            this.yaw = Math.toRadians(angles.firstAngle);
            this.pitch =  Math.toRadians(angles.secondAngle);
            this.roll =  Math.toRadians(angles.thirdAngle);
        }
        {
            this.xRotationRate = angularVelocity.xRotationRate;
            this.yRotationRate = angularVelocity.yRotationRate;
