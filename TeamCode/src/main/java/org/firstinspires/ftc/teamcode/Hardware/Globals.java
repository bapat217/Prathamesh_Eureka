...
* */
    ...
    public static double gripperServoOpen = 0.3733;
    public static double gripperServoClose = 0.61;//0.3594;// 0.3444;
    ...
    public static double INBET_elbowAfterPickSpecimenR = elbowAfterPickSpecimenL;
    public static double INBET_elbowAfterPickSpecimenL = elbowAfterPickSpecimenR;
