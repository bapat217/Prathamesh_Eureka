...
//@Config
//
//public class Eureka_PV2 extends LinearOpMode {
//
//    // TODO Teleop Flags
...
//
//            // TODO BOOLEAN FLAGS
//            if(robot.horizontalExtension.getCurrentPosition()<3){ XTransFlag = true;} else {XTransFlag = false;}
//
//
//            // TODO Toggle
//            boolean L_B_current_state = gamepad1.left_bumper;
//            boolean R_B_current_state = gamepad1.right_bumper;
//            if(L_B_current_state  && !L_B_last_state){ L_B_toggle_state = !L_B_toggle_state;}
//            if(R_B_current_state  && !R_B_last_state){ R_B_toggle_state = !R_B_toggle_state;}
//            L_B_last_state = L_B_current_state;
//            R_B_last_state = R_B_current_state;
//
//            // TODO MODE
//            // --------------------Sample mode
//            if(gamepad2.back){sample = true;specimen = false;}
//            // -------------------Specimen mode
//            if(gamepad2.start){
//                sample = false;
//                specimen = true;
...
//            }
//
//            if(transfer && (robot.horizontalExtension.getCurrentPosition()<=2) /*&& robot.iShoulder.getPosition() ==Globals.iShoulder_Transfer*/){
//                runningActions.add(new SequentialAction(
////                        new SleepAction(0.5),
//                        P_SamplePick.SampleOutTakeGOpen(intake, outtake),
//                        new SleepAction(0.1),
...
//            }
//
////            else if(!L_B_toggle_state && (robot.colorSensorOut.getDistance(DistanceUnit.MM) >= Globals.ColourDistanceOutake) && sample) {
////             runningActions.add(new SequentialAction(
...
////
//            // Specimen intake
////            if((robot.colorSensorOut.getDistance(DistanceUnit.MM) <= Globals.ColourDistanceOutake) /*&& !Globals.test*/ && specimen) {
////                runningActions.add(new SequentialAction(
...
////            }
//
////            if(robot.colorSensorOut.getDistance(DistanceUnit.MM) <= Globals.ColourDistanceOutake && speciBool){
////                runningActions.add(new SequentialAction(
////                        new InstantAction(()-> spaciBool= true),
////                        new SleepAction(0.3),
////                        new InstantAction(()-> spaciBool= false)
////                ));
////            }
//            if(gamepad1.start && specimen){
//                runningActions.add(new SequentialAction(
//                                SpecimenOuttakeSequence.SpecimenOuttakeAfterPick(outtake)
////                        SpecimenOuttakeSequence.SAMSpecimenOuttakeAfterPick(outtake)
//
//                        )
//                );
//            }
...
////            }
////            // wrist pose
////            if(gamepad2.x && specimen){
////                runningActions.add(new SequentialAction(
////                        P_SamplePick.wristPose(intake,Intake.iWristStates.POSE_0)
////                ));
////            }
//            if(gamepad2.b && specimen){
//                runningActions.add(new SequentialAction(
//                        P_SamplePick.wristPose(intake,Intake.iWristStates.POSE_90)
//                ));
//            }
...
//
//
////            if((robot.colorSensorOut.getDistance(DistanceUnit.MM) <= Globals.ColourDistanceOutake) && !Globals.test){
//////                if(gamepad1.a){
...
////                );
////
////                Globals.test= true; // need to check
////
////            }
//
////
...
//        telemetry.addData("Vertical Motor curr pose:", robot.verticalSliderRight.getCurrentPosition());
//        telemetry.addData("Vertical Motor curr pose:", robot.verticalSliderLeft.getCurrentPosition());
